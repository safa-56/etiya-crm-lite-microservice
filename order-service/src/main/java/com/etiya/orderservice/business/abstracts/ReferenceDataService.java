 ...
 *
 * <p>Bu servis, order-service'in sahip olduğu referans dilimini stabil iş kodları
 * üzerinden çözer. Diğer manager'lar referans tablolarına doğrudan repository ile
 * değil, bu servis üzerinden erişir.
 */
public interface ReferenceDataService {
     ...
     *
     * @param entityCodeName sahip olunan dilim (bkz. {@code OrderReferenceCodes.ENTITY_*})
     ...
     *
     * @param entityCodeName sahip olunan dilim (bkz. {@code OrderReferenceCodes.ENTITY_*})
     * @param shortCode      stabil iş kodu (ör. {@code FINISHED})
     */
