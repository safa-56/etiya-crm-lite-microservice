package com.etiya.orderservice.entities.outbox;
 ...
 *
 * <p>Alan adları, {@code infra/debezium/register-order-connector.json} içindeki
 * EventRouter eşlemeleriyle birebir uyumludur.
 */
@Getter
@Setter
@NoArgsConstructor
...
public class OutboxEvent {
    ...
    /** Agrega tipi (route.by.field) — ör. "OrderCheckoutSaga". Topic yönlendirmesini belirler. */
    @Column(name = "aggregate_type", nullable = false)
    private String aggregateType;

    /** Agrega kimliği (event.key) — ör. sipariş id'si. Kafka mesaj anahtarı olur. */
    @Column(name = "aggregate_id", nullable = false)
    private String aggregateId;

    /** Olay tipi (event.type) — ör. "OrderCheckoutRequested". */
