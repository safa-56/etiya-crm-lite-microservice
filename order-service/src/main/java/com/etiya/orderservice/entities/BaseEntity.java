 ...
 * {@code isActive} bayrağı kaldırılmıştır; bir kaydın durumu artık
 * {@code general_status} referans tablosuna FK ile taşınır (bkz.
 * {@link StatusAwareEntity}). Referans tabloları ({@code general_status},
 * {@code general_type}) doğrudan bu sınıftan türer. {@code deletedDate} bir denetim
