...
/**
 * bff-service - OAuth2 Resource Server (JWT) güvenlik konfigürasyonu.
 *
 * <p>Gateway kimlik doğrulamayı zaten yapar; burada token <b>yeniden doğrulanır</b>
 * (defense-in-depth). Servis stateless'tır; her istek Bearer token ister. Bu token,
 * downstream servislere ({@code customer-service}, {@code account-service}) aynen
 * aktarılır (bkz. {@link RestClientConfig}).
 *
 * <p>Public uçlar: actuator health/info. Diğer tüm uçlar geçerli JWT ister.
 */
@Configuration
@EnableWebSecurity
