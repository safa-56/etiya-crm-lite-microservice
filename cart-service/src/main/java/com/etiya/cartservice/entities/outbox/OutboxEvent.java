package com.etiya.cartservice.entities.outbox;
 ...
 *
 * <p>Alan adları, {@code infra/debezium/register-cart-connector.json} içindeki
...
public class OutboxEvent {
    ...
    /** Agrega tipi (route.by.field) — ör. "Cart". Topic yönlendirmesini belirler. */
    @Column(name = "aggregate_type", nullable = false)
    private String aggregateType;

    /** Agrega kimliği (event.key) — ör. sepet id'si. Kafka mesaj anahtarı olur. */
    @Column(name = "aggregate_id", nullable = false)
    private String aggregateId;

    /** Olay tipi (event.type) — ör. "CartItemAdded". */
