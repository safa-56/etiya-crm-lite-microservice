 ...
 *
 * <p>Teklif Seçimi ekranı (FR-014) için {@code ?catalogId=} ile katalog (kategori)
 * bazlı sayfalı arama sağlar.
 */
@RestController
...
public class ProductOffersController {
    ...
    /**
     * Teklifleri sayfalı listeler. {@code catalogId} verilirse ilgili kataloga
     * (kategoriye) bağlı teklifler döner (Teklif Seçimi Catalog sekmesi);
     * verilmezse tüm aktif teklifler döner.
     */
    @GetMapping
