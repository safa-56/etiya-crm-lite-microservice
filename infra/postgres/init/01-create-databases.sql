...
-- account-service (accountdb), product-service (productdb), cart-service (cartdb) ve
-- order-service (orderdb) kendi veritabanlarına ihtiyaç duyduğundan burada oluşturulur.
-- Her servis kendi şemasına/Debezium slot'una sahiptir.
--
...
-- veritabanlarını elle oluşturmak için: CREATE DATABASE accountdb; / CREATE DATABASE productdb; / CREATE DATABASE cartdb; / CREATE DATABASE orderdb;
-- =============================================================================
