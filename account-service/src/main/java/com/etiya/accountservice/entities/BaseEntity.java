 ...
 * {@code isActive} bayrağı kaldırılmıştır; bir kaydın aktif/beklemede/iptal/silinmiş
 ...
 * ({@code general_status}, {@code general_type}) kendileri durum taşımadığından
 * doğrudan bu sınıftan türer. {@code deletedDate} bir denetim zaman damgasıdır
 * (durum alanı değildir) ve soft-delete filtrelerinde kullanılır.
 */
@Getter
@Setter
@MappedSuperclass
