package com.etiya.accountservice.entities.outbox;
 ...
 *
 * <p>Alan adları, {@code infra/debezium/register-account-connector.json}
...
public class OutboxEvent {
    ...
    /** Agrega tipi (route.by.field) — ör. "Account". Topic yönlendirmesini belirler. */
    @Column(name = "aggregate_type", nullable = false)
    private String aggregateType;

    /** Agrega kimliği (event.key) — ör. fatura hesabı id'si. Kafka mesaj anahtarı olur. */
    @Column(name = "aggregate_id", nullable = false)
    private String aggregateId;

    /** Olay tipi (event.type) — ör. "BillingAccountCreated", "BillingAccountDeleted". */
