package com.etiya.searchservice.core.crosscutting.exceptions.handlers;
 ...
 * RFC 7807 uyumlu {@link ProblemDetail} yanıtlarına çevirir. FR-002 arama
 * parametrelerinin format ihlalleri (ACC-04..10) {@link BusinessException} ile
 * 400 döner.
 */
...
public class GlobalExceptionHandler {
    ...
    /** İş kuralı / format ihlalleri → 400 Bad Request. */
